...
<div class="table_box">
	...
	<div class="col-sm-6">
		<div class="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main">
					<div id="piechart-placeholder6"></div>
	
					<div class="hr hr8 hr-double"></div>
	
					<div class="clearfix">
						<#list orderStatByUntsType as osu>
							<div class="grid2">
								<span class="grey">
									<i class="icon-pinterest-sign icon-2x red"></i>
									&nbsp;${osu.product_name!}
								</span>
								<h4 class="bigger pull-right">${osu.amount!0}</h4>
							</div>
						</#list>
					</div>
				</div><!-- /widget-main -->
		...
		<div class="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main">
					...
					<div class="clearfix">
						<#list statByStore as sbs>
							<div class="grid2">
								<span class="grey">
									<i class="icon-pinterest-sign icon-2x red"></i>
								&nbsp;${sbs.store_name!'未知'}
								</span>
								<h4 class="bigger pull-right">${sbs.count!0}</h4>
							</div>
						</#list>
					</div>
				</div><!-- /widget-main -->
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
			  ...
			  var data3 =[
			  	<#list statByStore as sbs>
			  		{ label: "${sbs.store_name!'未知'}",  
			  		data: ${sbs.count!0},
					color: colors[${sbs_index}]
					},
				</#list>
			  ];
			  ...
			  var data6 =[
			  	<#list orderStatByUntsType as osu>
			  		{ label:'${osu.product_name!}',  
			  		data: ${osu.amount!0},
					color: colors[${osu_index}]
					},
				</#list>	
			  ];
			  var data7 =[
			 ...
			 */
			 ...
			 placeholder3.data('draw', drawPieChart(placeholder3, data3));
			 ...
			 placeholder6.data('chart', data6);
			 placeholder6.data('draw', drawPieChart(placeholder6, data6));

...
<form action="${CONTEXT_PATH}/activityManage/saveMCarousel" class="form-horizontal" role="form" method="post">
    ...
    <input type="hidden" name="mCarousel.type_id" value="4"/>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="url">url </label>

        <div class="col-sm-9">
            <input type="text" id="url" name="mCarousel.url" value="${mCarousel.url!}" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right">名称 </label>
        <div class="col-sm-9">
            <input type="text" id="carousel_name" name="mCarousel.carousel_name" value="${mCarousel.carousel_name!}" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" readonly id="img_id" name="mCarousel.img_id" value="${mCarousel.img_id!}" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
	        ...
	        <img src="${(image.save_string)!}" id="url2" onerror="imgLoad(this)" />

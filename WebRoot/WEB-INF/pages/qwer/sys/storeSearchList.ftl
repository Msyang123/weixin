								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="store.head_preson"
											class="col-xs-10 col-sm-5" onblur="checkStorePreson();"/> <span
											class="help-inline col-xs-12 col-sm-7"> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input class="input-sm" type="text" name="store.tel" id="tel"
											/><!--placeholder="0731-" onblur="checkSubmitMobil();" --> <span
									...
									<div class="col-sm-4">
										<div class="clearfix">
											<select id="form-field-select-1" name="store.corp_id"
												class="form-control">
												<option value="">无</option> <#list corpAll as c>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input class="input-sm" type="text"  name="store.tel" id="modify_tel"
											placeholder="0731-"  /> <span
											id="telModifymsg" class="middle"></span>
										<div class="space-2"></div>
...
<div class="table_box">
	...
	actionUrl="/m/role/storeSearch/" urlParas="?msg=${msg!}&store_area=${store_area!}"/>
</div>
...
function modify(id) {
	$.ajax({ // 一个Ajax过程
		...
		success : function(json) {
			...
			$("#modity_store_area").val(json.mm.store_area);

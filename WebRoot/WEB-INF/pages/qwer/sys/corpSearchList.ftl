						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" action="m/role/addCorp"
									...
									<input type="hidden" id="filesrc" name="corp.corp_logo"></input>
										...
										<span class="help-inline col-xs-12 col-sm-7"> <span
											id="logoMsg" class="middle"><img id="zstp1" 
												width="100" height="45" src="img/moren.jpg"></span>
										</span>
									</div>
								</div>
                                <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="clearfix">
											<input class="col-xs-10 col-sm-5" type="text" name="corp.tel" id="tel"
												placeholder="0731-" /> <span id="telMsg" class="middle"></span>
										</div>
										<div class="space-2"></div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<input type="hidden" id="modifyfilesrc" name="corp.corp_logo"></input>
										<input type="file" id="modify_corp_logo" name="modify_corp_logo"
											...
											class="help-inline col-xs-12 col-sm-7"> <span
											id="logoMsg" class="middle"><img id="modifyzstp1" 
...
<div class="table_box">
		...
		<tbody>
			...
			<form action="m/role/deleteCorp" method="post">
				<tr class="myclass">
					...
					<td style="text-align: center;">${(x.corp_typea)!}</td>
	...
	actionUrl="/m/role/corpSearch/" urlParas="?msg=${msg!}&corp_type=${corp_type!}" />
</div>
...
function modify(id) {
	$.ajax({ // 一个Ajax过程
		...
		success : function(json) {
			...
			//$("#modify_corp_logo").val(json.mm.corp_logo);
			$("#modify_corp_addr").val(json.mm.corp_addr);
			$("#modify_corp_addr").val(json.mm.corp_type);
			$("#modify_head_preson").val(json.mm.head_preson);
			$("#modify_tel").val(json.mm.tel);
			$("#modify_map_index").val(json.mm.map_index);

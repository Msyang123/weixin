...
<form action="${CONTEXT_PATH}/productManage/save" class="form-horizontal" role="form" method="post">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="dis_order">商品等级 </label>

        <div class="col-sm-9">
            <input type="text" id="dis_order" name="activity.subheading" placeholder="商品等级" 
            value="${product.product_grade!}" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <select id="product_status" name="product.product_status">
            	<#if product.product_status??>
	        		...
	        		<option value="03" <#if product.product_status=='03'>selected</#if>>停止下单</option>
        		<#else>
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="url">主图 </label>
        <div class="col-sm-9">
	...
	<div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="activity_type" name="product.base_unit" 
            placeholder="基础单位" value="${product.base_unit!}" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="safe_qty">安全库存 </label>
        <div class="col-sm-9">
        	<input type="text" id="safe_qty" name="product.safe_qty" value="${product.safe_qty!1.00}"
        	 class="col-xs-10 col-sm-5" ></input>
		</div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="editor">详细描述 </label>
...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        //data: grid_data,
        url:"${CONTEXT_PATH}/productManage/productFList?productId=${product.id!0}",
        mtype: "post",
        datatype: "json",
        height: '100%',
        colNames:["操作",'编号','产品编码','条码','规格数量',  '单位','规格','价格','特价','赠送商品','有效','商品规格描述','二维码'],
        colModel:[
            ...
            {name:'pf.is_gift',index:'is_gift', width:150,editable: true,
            ...
            {name:'pf.product_f_des',index:'product_f_des', width:150,editable: true},

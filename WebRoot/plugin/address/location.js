...
var currentLocation = "湖南";
var currentProvinceId = 18;
...
function chooseProvince(provinceId){
	...
	if(!page_load){
		currentAreaInfo.currentCityId = 1482;
		currentAreaInfo.currentCityName = "长沙市";
		currentAreaInfo.currentAreaId = 410006;
		currentAreaInfo.currentAreaName = "岳麓区";
		currentAreaInfo.currentTownId = 0;
		currentAreaInfo.currentTownName = "";
	}
...
function chooseCity(cityId,cityName){
	...
	$.ajax({
		...
		success:function(result){
			getAreaListcallback(result);
		},
		error:function(result){
			areaContainer.show().html("<div class='iloading'>加载数据错误...</div>");
		}
	});
	//$.getJSONP("area?fid="+cityId+"&callback=getAreaListcallback");
}
function chooseArea(areaId,areaName){
	...
	//$.getJSONP("area?fid="+areaId+"&callback=getAreaListcallback");
}
...
function CurrentAreaInfoInit(){
	currentAreaInfo =  {"currentLevel": 1,"currentProvinceId": 18,"currentProvinceName":"湖南","currentCityId": 1482,"currentCityName":"长沙市","currentAreaId": 410006,"currentAreaName":"岳麓区","currentTownId":0,"currentTownName":""};
	var ipLoc = getCookie("ipLoc-djd");
	ipLoc = ipLoc?ipLoc.split("-"):[18,1482,410006,0];
